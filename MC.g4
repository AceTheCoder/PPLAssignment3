...
for_statement:
                FOR LB exp SEMI exp SEMI exp RB
                    statement
                ;
...
array_element: (funcall | ID ) LSB exp RSB;
...
exp4 : exp5 (LT|LE|ST|SE) exp5 | exp5;
exp5 : exp5 (ADDOP|MINUSOP) exp6 | exp6;
exp6 : exp6 (DIVOP|MULOP|MODOP) exp7 | exp7;
exp7 : (MINUSOP|NOT) exp7 | exp8;
